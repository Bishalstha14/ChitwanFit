...
> **Stages 1-2 complete.** ChitwanFit idea discovered, evaluated with the
> 5-Point Filter (verdict: Solid), Founder Decision recorded in
> `build-lab/MISSION.md` (Section 0). Stage 2 scope refined: first launch user
> = the local community; 20-Second Check passed; Core Solution and Primary CTA
> locked. Moving into Stage 3 (visual identity).
...
- [ ] Step 1: Base shell + CSS design tokens in `build-lab/index.html` and `build-lab/style.css`
- [ ] Step 2: Navbar and Hero section
- [ ] Step 3: Content sections (Problem, Solution, Features, Social Proof, Footer)
- [ ] Add one professional component and apply the motion budget
- [ ] Run the 5-Point Quality Audit and fix Critical + Important issues
